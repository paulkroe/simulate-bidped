# scripts/biped/stream_biped_v2.py
"""
Visualize trained biped policy in browser.
"""
...
def make_env() -> MujocoEnv:
    ...
    cfg = MujocoEnvConfig(
        ...
        episode_length=5000,  # Longer episodes for visualization
        frame_skip=5,
        ctrl_scale=0.05,
...
def main():
    ...
    # Try both checkpoint names
    # checkpoint_path = "checkpoints/biped_v2_mp.pt"  # Multi-process version
    # checkpoint_path = "checkpoints/biped_v2.pt"  # Single-process version
    checkpoint_path = "checkpoints/biped_pretrained.pt"    
    
    device = "cpu"

    print("="*60)
    print("Biped Walker Visualization - V2")
    print("="*60)
