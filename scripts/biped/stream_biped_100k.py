# scripts/biped/stream_biped_100k.py
"""
Test policy trained with 100k demonstrations.
"""
...
def main():
    ...
    checkpoint_path = "checkpoints/biped_pretrained_100k.pt"
    device = "cpu"

    print("="*60)
    print("Biped Walker - Trained with 100k Demonstrations")
    print("="*60)
    print(f"Checkpoint: {checkpoint_path}")
    print(f"Server: http://localhost:8000")
    print("="*60)
    print("This policy was trained with:")
    print("  - 100k demonstrations (10x more)")
    print("  - 1000 epochs (2x more)")
    print("Should have learned weight shifting")
    print("="*60)
